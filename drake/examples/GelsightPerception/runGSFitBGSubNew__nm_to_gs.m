...
%     gradc_img_2D = conv2(depth_img_2D(:,:,1),[1,-1],'same');
    ...
    out_imgs_2D{image_counter} = ref_img_2D;
    in_imgs_2D{image_counter} = normals_img_2D;
